...
urlpatterns = [
    ...
    path('registr/' ,views.RegisterUser.as_view() , name='registr'),
    ...
    path('password-reset/',
         PasswordResetView.as_view(template_name = "user/password_reset_form.html", email_template_name="user/password_reset_email.html", success_url=reverse_lazy("user:password_reset_done")),
         name='password_reset'),
